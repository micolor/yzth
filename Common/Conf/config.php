...
$config= array(
    ...
    'APP_GROUP_LIST'=>'Home,Admin,Weixin',// 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
	/*分页*/
	'VAR_PAGE'=>'page',
    /* Cookie设置 */
    'COOKIE_EXPIRE'         =>  0,       // Cookie有效期
    'COOKIE_DOMAIN'         =>  '.gsmh.com',      // Cookie有效域名
    'COOKIE_PATH'           =>  '/',     // Cookie路径
    'COOKIE_PREFIX'         =>  '',      // Cookie前缀 避免冲突
    'COOKIE_SECURE'         =>  false,   // Cookie安全传输
    'COOKIE_HTTPONLY'       =>  '',      // Cookie httponly设置
	 /*同步解密密钥*/
	'TB_HASH' => '0lLf5nfO', // Cookie前缀 避免冲突
...
//  'TMPL_ACTION_SUCCESS'   =>  THINK_PATH.'Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
 ...
 // 'TMPL_EXCEPTION_FILE'   =>  THINK_PATH.'Tpl/think_exception.tpl.bak',// 异常页面的模板文件
