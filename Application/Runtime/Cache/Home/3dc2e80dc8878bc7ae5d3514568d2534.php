...
<div id="banner">
    ...
    <div id="page_main" class="clearfix">
        <div class="page-right">
            <h3 class="site-title"><?php echo ($title); ?></h3>
            <div class="site-nav"><span>当前位置 : </span><a href="/">公司主页</a> &gt;&gt; <a href="/products" title="产品展示">产品展示</a>
            </div>
            <div class="page-products">
                <ul class="clearfix">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="<?php echo u('/products/detail',array('id'=>$vo['nid']));?>" title="<?php echo ($vo["title"]); ?>">
                            <img src="<?php echo ($vo["thumb"]); ?>" width="210" height="150" alt="<?php echo ($vo["title"]); ?>"/><span><?php echo (cut_string( $vo["title"],15)); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <div class="page_list">
                   <?php echo ($page); ?>
                </div>
