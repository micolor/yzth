...
<div id="MainMenu" class="ddsmoothmenu">
    <ul>
        ...
        <li><a href="/products" title="产品展示"><span>产品展示</span></a>
            <ul class="menulevel">
                <?php if(is_array($productcat)): $i = 0; $__LIST__ = $productcat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/products" title="<?php echo ($vo["cate_name"]); ?>"><?php echo ($vo["cate_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </li>
    ...
    <div id="page_main" class="clearfix">
        <div class="page-right">
            <div class="site-nav">
                ...
                <span>当前位置 : </span><a href="/">公司主页</a> &gt;&gt; <a href="/products" title="产品展示">产品展示</a>
            </div>
