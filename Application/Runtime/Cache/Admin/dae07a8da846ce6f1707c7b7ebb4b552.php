...
<form name="myform" id="myform" action="<?php echo ($act); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="addContent">
        <div class="crumbs">当前位置：产品 > 产品发布管理 > 添加产品</div>
        <div class="col-right">
            <div class="col-1">
                    ...
                    <script type="text/javascript">
                        KindEditor.ready(function (K) {
                            var uploadbutton = K.uploadbutton({
                                ...
                                fieldName: 'imgFile',
                                url: "<?php echo U('Admin/Products/ajaximg');?>",
            ...
            <div class="col-1">
                <div class="content pad-6">
                    <table width="100%" cellspacing="0" class="table_form">
                        <tbody>
                        <tr>
                            <th width="80"><font color="red">*</font> 分类</th>
                            <td>
                                <select name="catid">
                        ...
                        <tr>
                            <th width="80"><font color="red">*</font> 产品</th>
                            <td>
                        ...
                        <tr>
                            <th width="80" style="color:#F00">是否推荐</th>
                            <td>
                                <input name="istj" type="radio" value="1"
                                <?php if($info[istj]==1 || $act='add'){echo "checked";} ?>
                                /> 推荐 &nbsp; &nbsp; &nbsp; &nbsp;
                                <input name="istj" type="radio" value="2"
                                <?php if($info[istj]==2){echo "checked";} ?>
                                /> 不推荐
                            </td>
                        </tr>
                        <tr>
                            <th>产品内容</th>
                            <td><textarea name='content' id="content" style="width:637px; height:500px; max-width:637px;resize:none;"><?php echo ($info["content"]); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th width="80"> 分页方式</th>
