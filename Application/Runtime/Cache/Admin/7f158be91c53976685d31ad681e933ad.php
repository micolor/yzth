...
<div class="showMsg" style="text-align:center">
	...
	<div class="content guery" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px"><?php echo ($error); ?></div>
	<div class="bottom">
...
<?php if(($jumpUrl == 'edit') or ($jumpUrl == 'add') ): ?><script language="javascript">
		...
		setTimeout("close_dialog()",<?php echo ($waitSecond); ?>);
	...
	<script language="javascript">
		setTimeout("redirect('<?php echo ($jumpUrl); ?>');",<?php echo ($waitSecond); ?>);
	</script><?php endif; ?>
</body>
</html>