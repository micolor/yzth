...
<head>
	...
	<title>联系我们</title>
	<meta name="keywords" content="联系我们管理">
	<meta name="description" content="联系我们管理">
				...
				<div class="ibox-title">
					...
					<div class="ibox-tools">
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a href="<?php echo U('Leanmanage/add');?>">添加联系我们</a>
							</li>
							</li>
						</ul>
					...
					<div class="table-responsive">
						<table class="table table-striped">
							...
							<?php if(is_array($datas)): foreach($datas as $key=>$li): ?><tr>
									...
									<td><?php echo ($li["leanname"]); ?></td>
									<td><?php echo ($li["email"]); ?></td>
									<td><?php echo ($li["message"]); ?></td>
									<td align='left'>
										<a href="<?php echo U('Leanmanage/query',array('id'=>$li['id']));?>" title="查询"><span class="glyphicon" aria-hidden="true">查询</span></a>&nbsp;&nbsp;|&nbsp;&nbsp;
										<a href="<?php echo U('Leanmanage/delete',array('id'=>$li['id']));?>" onclick="Delete(this);return false;" title="删除"><span class="glyphicon" aria-hidden="true">删除</span></a>
									</td>
