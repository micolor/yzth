...
<div class="wrapper wrapper-content animated fadeInRight">
				...
				<div class="ibox-title">
					...
					<div class="ibox-tools">
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a href="<?php echo U('Productscat/add');?>">添加分类</a>
							</li>
						</ul>
				...
				<div class="ibox-content">
					<div class="table-responsive">
						<table class="table table-striped">
							...
							<tbody>
							<form name="myform" action="<?php echo U('Productscat/listorders');?>" method="post">
							<?php
 if(is_array($data)){ foreach($data as $cate){ ?>
							<tr>
								...
								<td align="left">
									<!--<a href="<?php echo U('Productscat/add',array('cate_id'=>$cate['cate_id']));?>">添加下级分类</a> |-->
									<a href="<?php echo U('Productscat/edit',array('cate_id'=>$cate['cate_id']));?>">修改</a> |
									<a href="<?php echo U('Productscat/delete',array('cate_id'=>$cate['cate_id']));?>" onclick="Delete(this);return false;">删除</a>
								</td>
							</tr>
						...
						<div style="width:100%;margin-top: -20px;">
							...
							<input type="submit" class="btn btn-primary J_ajax_submit_btn" name="dosubmit" value="排序" onClick="document.myform.action='<?php echo U("Productscat/listorders");?>';myform.submit();" />
						</div>
						<?php echo ($page); ?>
					</div>
