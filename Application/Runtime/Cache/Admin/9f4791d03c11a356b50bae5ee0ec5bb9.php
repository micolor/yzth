                    ...
                    <form novalidate="novalidate" class="form-horizontal m-t" id="myform" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10  control">
                                <input type="text" name="sort_order" class="form-control" id="sort_order"
                                       value="<?php echo ($cate["sort_order"]); ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10  control">
                                <textarea id="category_desc" name="category_desc" class="form-control" rows="2"
                                          cols="20"><?php echo ($cate["category_desc"]); ?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10  control">
                                <input type="text" name="category_keywords" class="form-control" id="category_keywords"
                                       value="<?php echo ($cate["category_keywords"]); ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div id="parterlogo">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div id="fileList" class="uploader-list">
                                        <div class="file-item thumbnail">
                                            <?php if($cate[cthumb]): ?><img src="<?php echo ($cate["cthumb"]); ?>"><?php endif; ?>
                                        </div>
                                    </div>
                                    <input type="hidden" name="cthumb" id="filepath" value="<?php echo ($cate["cthumb"]); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10  control">
                                ...
                                <?php if($cate[is_show]==1 || $act='add'){echo "checked";} ?>
                                /> 展示 &nbsp; &nbsp; &nbsp; &nbsp;
                                <input name="is_show" type="radio" value="2"
                                <?php if($cate[is_show]==2){echo "checked";} ?>
                                /> 不展示
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
